...
public class TrunkType extends DefaultType {
    @Override
    ...
    public Vec3 getExteriorPosition(ITardisLevel level) {
        ...
        Vec3 extOffset = new Vec3(0, 0.55, 0);

        extOffset = extOffset.relative(extDirection, 0.15);
